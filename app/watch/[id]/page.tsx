        ...
        return (
            <>
                <div className=" h-full flex flex-col w-full items-center justify-center">
                    ...
                    <Link
                        href={"/watch"}
                        className="absolute left-4 top-3 px-3 py-[2px] font-bold text-lg flex flex-row items-center justify-center hover:underline hover:bg-customSec hover:text-customLight transition-all duration-150 rounded-lg"
