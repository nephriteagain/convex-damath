                        ...
                        <div className=" bg-customBg p-0 sm:px-2 py-1 w-full sm:w-[600px] h-[80%] overflow-y-auto">
                            {watchList.map((g) => {
                                ...
                                return (
                                    <div
                                        key={_id}
                                        className="text-sm sm:text-base flex flex-row px-1 sm:px-2 py-1 mb-2 bg-customSec"
                                    >
                                        <div className="basis-[27%] overflow-clip px-2">
                                            {gameType}
                                        </div>
                                        <div className="basis-[27%] overflow-clip px-2">
                                            {players.z}
