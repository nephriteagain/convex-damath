...
export default function WatchLoading({
    ...
    return (
        <div className="flex flex-col w-full items-center justify-center">
            <section
                className="mt-12 w-full sm:w-auto bg-customNeutral p-1 sm:p-8 pt-4  text-white h-[500px]"
            ...
            <Link
                href="/"
                className="mt-2 underline decoration-2 text-xl text-center hover:text-customSec transition-all duration-150"
