...
export default forwardRef(function Board(
    { gameBoard = COUNTING, players, playerTurn, side }: BoardProps,
    ref: Ref<HTMLDivElement>,
) {
    const numArr = side === "BLUE" ? numReverse : num;
    return (
        <div
            className="board relative  w-[95%] max-w-[450px] sm:w-[450px] aspect-square grid grid-cols-8 grid-rows-[8] bg-slate-100 shadow-xl drop-shadow-lg"
            ref={ref}
        >
