...
export default function About() {
    return (
        <Dialog>
            <DialogTrigger className="w-full flex flex-row gap-2  items-center justify-center px-3 text-2xl bg-customNeutral max-w-[200px] py-1 text-md text-white shadow-sm drop-shadow-md hover:scale-105 active:scale-95 transition-all duration-150 rounded-md hover:bg-customSec">
                <p>About</p>
                <BsInfoCircle />
            </DialogTrigger>
