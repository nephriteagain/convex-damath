...
export default function Scores({score, className}: ScoresProps) {
    ...
    return (
        <section className={`select-none w-[95%] max-w-[500px] sm:w-[500px] flex flex-row bg-stone-300 text-lg sm:text-xl font-semibold items-center justify-between px-4 py-2 mb-2 rounded-sm shadow-sm drop-shadow-sm ${className}`}>
