    ...
    return (
        <div className="flex flex-row gap-2 sm:gap-4">
            <Select onValueChange={(v) => changeFilter(v)}>
                <SelectTrigger
                    className={`sm:text-sm w-[100px] text-sm bg-customLight border-transparent ${className}`}
                >
                    <SelectValue placeholder="filter" />
                </SelectTrigger>
                <SelectContent
                    className={`bg-customLight transition-all duration-100 ${className}`}
                >
                    <SelectGroup>
            ...
            >
                <SelectTrigger
                    className={`sm:text-sm w-fit text-sm bg-customLight border-transparent ${className}`}
                >
                    <SelectValue
