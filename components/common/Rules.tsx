...
function Rules({ setOpenRules, openRules }: RuleProps) {
  ...
  return (
    <div className=" cursor-grab rule-popup  p-[1rem] absolute w-full sm:w-[500px] h-[60vh] sm:h-[75vh] overflow-auto  top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] shadow-xl drop-shadow-lg rounded-lg"  
      ref={popupRef}
    >
        <div className='mb-8'>
