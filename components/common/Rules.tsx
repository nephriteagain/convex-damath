...
function Rules({ setOpenRules, openRules }: RuleProps) {
    ...
    return (
        <div
            className=" cursor-grab rule-popup  p-[1rem] absolute w-full sm:w-[500px] h-[60vh] sm:h-[75vh] overflow-auto  top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] shadow-xl drop-shadow-lg rounded-lg"
            ref={popupRef}
        >
            <div className="mb-8">
                <h2 className="text-2xl font-bold">DAMATH</h2>
                <h3 className="text-lg font-semibold opacity-60">
                    Rules of Play
                </h3>
            </div>
            <span
                className="absolute top-4 right-4 text-xl cursor-pointer hover:text-red-800 hover:scale-125 transition-all duration-150"
