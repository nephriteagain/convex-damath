...
export default forwardRef(function Room(
    { _id, userId }: RoomProps,
    ...
    if (!room) {
        return (
            <SheetContent className="bg-customNeutral">Loading...</SheetContent>
        );
    }
    ...
    return (
        <SheetContent
            className="bg-customNeutral text-white overflow-y-auto"
            ref={ref}
        >
                    ...
                    {host === userId ? (
                        <div className="flex flex-row justify-between">
                            ...
                            >
                                ...
                                <p
                                    className={
                                        leaveLoading ? "invisible" : "visible"
                                    }
                                >
                                    Leave Game
                                </p>
                            ...
                            >
                                ...
                                <p
                                    className={
                                        startLoading ? "invisible" : "visible"
                                    }
                                >
                                    Start Game
                                </p>
