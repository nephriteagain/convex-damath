...
export default function Scores({score}: ScoresProps) {
    ...
    return (
        <section className="w-[500px] flex flex-row bg-stone-300 text-xl font-semibold items-center justify-between px-4 py-2 mb-2 rounded-sm shadow-sm drop-shadow-sm">
